...
var TankGame	= jsbattle.Game.extend({
	...
	addShoot	: function(shoot){
		this.shoots.push(shoot)
		this.world.addBody(shoot);
		return this;
	},
	delShoot	: function(shoot){
		console.assert( this.shoots.indexOf(shoot) != -1 )		
		this.shoots.splice( this.shoots.indexOf(shoot), 1)
		this.world.delBody(shoot);
		return this;
	},
