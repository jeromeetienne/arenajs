require.module('./jsbattle_core', function(module, exports, require) {
// start module: jsbattle_core
...
jsbattleCore.prototype.addScript	= function(scriptId, scriptData){
	this.scripts[scriptId]	= scriptData;
}


jsbattleCore.prototype.start	= function(){
