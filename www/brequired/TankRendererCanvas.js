require.module('./TankRendererCanvas', function(module, exports, require) {
// start module: TankRendererCanvas
...
var TankRendererCanvas	= jsbattle.Renderer.extend({
	init	: function(opts){
	...
	*/
	renderWorld	: function(tankWorld, tickEvents){
		...
		tickEvents.forEach(function(event){
	...
	*/
	...
	/**
	 * Display a Body in a generic fasion
	*/
